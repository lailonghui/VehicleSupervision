...
func (r *mutationResolver) DeleteDisputeViolationRecord(ctx context.Context, where model.DisputeViolationRecordBoolExp) (*model.DisputeViolationRecordMutationResponse, error) {
	...
	var m = &model1.DisputeViolationRecord{}
	// 查询主键和联合主键
...
func (r *mutationResolver) DeleteDisputeViolationRecordByPk(ctx context.Context, id int64) (*model1.DisputeViolationRecord, error) {
	var rs model1.DisputeViolationRecord
	m := &model1.DisputeViolationRecord{}
	tx := db.DB.Model(m)
	// 查询记录
...
func (r *mutationResolver) InsertDisputeViolationRecordOne(ctx context.Context, objects model.DisputeViolationRecordInsertInput) (*model1.DisputeViolationRecord, error) {
...
func (r *mutationResolver) UpdateDisputeViolationRecord(ctx context.Context, inc *model.DisputeViolationRecordIncInput, set *model.DisputeViolationRecordSetInput, where model.DisputeViolationRecordBoolExp) (*model.DisputeViolationRecordMutationResponse, error) {
	qt := util.NewQueryTranslator(db.DB, &model1.DisputeViolationRecord{})
	var m = &model1.DisputeViolationRecord{}
	// 更新数据库
...
func (r *mutationResolver) UpdateDisputeViolationRecordByPk(ctx context.Context, inc *model.DisputeViolationRecordIncInput, set *model.DisputeViolationRecordSetInput, id int64) (*model1.DisputeViolationRecord, error) {
	var rs model1.DisputeViolationRecord
	var m = &model1.DisputeViolationRecord{}
	// 更新数据库
...
func (r *queryResolver) DisputeViolationRecord(ctx context.Context, distinctOn []model.DisputeViolationRecordSelectColumn, limit *int, offset *int, orderBy []*model.DisputeViolationRecordOrderBy, where *model.DisputeViolationRecordBoolExp) ([]*model1.DisputeViolationRecord, error) {
	var rs []*model1.DisputeViolationRecord
	var m = &model1.DisputeViolationRecord{}

...
// 新建主键dataloader
func (t *DataDictionaryPkLoader) NewLoader(ctx context.Context) *DataDictionaryPkLoader {
	return &DataDictionaryPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*DataDictionary, []error) {
			var rs []*DataDictionary = make([]*DataDictionary, len(keys))
...
// 新建联合主键dataloader
func (t *DataDictionaryUnionPkLoader) NewLoader(ctx context.Context) *DataDictionaryUnionPkLoader {

...
func (r *mutationResolver) DeleteTerminalParamItemByUnionPk(ctx context.Context, unionId string) (*model1.TerminalParamItem, error) {
	preloads := util.GetPreloads(ctx)
	var rs model1.TerminalParamItem
	tx := db.DB.Model(&model1.TerminalParamItem{})
	if len(preloads) > 0 {
...
func (r *mutationResolver) UpdateTerminalParamItemByUnionPk(ctx context.Context, inc *model.TerminalParamItemIncInput, set *model.TerminalParamItemSetInput, unionId string) (*model1.TerminalParamItem, error) {
	var rs model1.TerminalParamItem
...
func (r *queryResolver) TerminalParamItemByUnionPk(ctx context.Context, unionId string) (*model1.TerminalParamItem, error) {
	var rs model1.TerminalParamItem
	tx := db.DB.Model(&model1.TerminalParamItem{}).Select(util.GetTopPreloads(ctx)).Where(rs.UnionPrimaryColumnName()+" = ?", unionId).First(&rs)

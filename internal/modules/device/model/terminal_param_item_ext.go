...
// 新建主键dataloader
func (t *TerminalParamItemPkLoader) NewLoader(ctx context.Context) *TerminalParamItemPkLoader {
	return &TerminalParamItemPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*TerminalParamItem, []error) {
			var rs []*TerminalParamItem = make([]*TerminalParamItem, len(keys))
...
// 新建联合主键dataloader
func (t *TerminalParamItemUnionPkLoader) NewLoader(ctx context.Context) *TerminalParamItemUnionPkLoader {

...
// 新建主键dataloader
func (t *TerminalFactoryPkLoader) NewLoader(ctx context.Context) *TerminalFactoryPkLoader {
	return &TerminalFactoryPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*TerminalFactory, []error) {
			var rs []*TerminalFactory = make([]*TerminalFactory, len(keys))
...
// 新建联合主键dataloader
func (t *TerminalFactoryUnionPkLoader) NewLoader(ctx context.Context) *TerminalFactoryUnionPkLoader {

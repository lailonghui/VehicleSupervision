...
// 新建主键dataloader
func (t *TerminalModalPkLoader) NewLoader(ctx context.Context) *TerminalModalPkLoader {
	return &TerminalModalPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*TerminalModal, []error) {
			var rs []*TerminalModal = make([]*TerminalModal, len(keys))
			var m TerminalModal
			wg := sync.WaitGroup{}
...
// 新建联合主键dataloader
func (t *TerminalModalUnionPkLoader) NewLoader(ctx context.Context) *TerminalModalUnionPkLoader {

...
// 新建主键dataloader
func (t *TerminalChangePkLoader) NewLoader(ctx context.Context) *TerminalChangePkLoader {
	return &TerminalChangePkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*TerminalChange, []error) {
			var rs []*TerminalChange = make([]*TerminalChange, len(keys))
...
// 新建联合主键dataloader
func (t *TerminalChangeUnionPkLoader) NewLoader(ctx context.Context) *TerminalChangeUnionPkLoader {

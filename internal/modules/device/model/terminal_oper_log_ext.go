...
// 新建主键dataloader
func (t *TerminalOperLogPkLoader) NewLoader(ctx context.Context) *TerminalOperLogPkLoader {
	return &TerminalOperLogPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*TerminalOperLog, []error) {
			var rs []*TerminalOperLog = make([]*TerminalOperLog, len(keys))
...
// 新建联合主键dataloader
func (t *TerminalOperLogUnionPkLoader) NewLoader(ctx context.Context) *TerminalOperLogUnionPkLoader {

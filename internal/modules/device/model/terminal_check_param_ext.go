...
// 新建主键dataloader
func (t *TerminalCheckParamPkLoader) NewLoader(ctx context.Context) *TerminalCheckParamPkLoader {
	return &TerminalCheckParamPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*TerminalCheckParam, []error) {
			var rs []*TerminalCheckParam = make([]*TerminalCheckParam, len(keys))
...
// 新建联合主键dataloader
func (t *TerminalCheckParamUnionPkLoader) NewLoader(ctx context.Context) *TerminalCheckParamUnionPkLoader {

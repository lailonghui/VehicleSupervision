...
// 新建主键dataloader
func (t *FingerprintDriverPkLoader) NewLoader(ctx context.Context) *FingerprintDriverPkLoader {
	return &FingerprintDriverPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*FingerprintDriver, []error) {
			var rs []*FingerprintDriver = make([]*FingerprintDriver, len(keys))
...
// 新建联合主键dataloader
func (t *FingerprintDriverUnionPkLoader) NewLoader(ctx context.Context) *FingerprintDriverUnionPkLoader {

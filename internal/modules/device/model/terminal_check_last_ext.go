...
// 新建主键dataloader
func (t *TerminalCheckLastPkLoader) NewLoader(ctx context.Context) *TerminalCheckLastPkLoader {
	return &TerminalCheckLastPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*TerminalCheckLast, []error) {
			var rs []*TerminalCheckLast = make([]*TerminalCheckLast, len(keys))
...
// 新建联合主键dataloader
func (t *TerminalCheckLastUnionPkLoader) NewLoader(ctx context.Context) *TerminalCheckLastUnionPkLoader {

...
// 新建主键dataloader
func (t *TerminalParamSubPkLoader) NewLoader(ctx context.Context) *TerminalParamSubPkLoader {
	return &TerminalParamSubPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*TerminalParamSub, []error) {
			var rs []*TerminalParamSub = make([]*TerminalParamSub, len(keys))
...
// 新建联合主键dataloader
func (t *TerminalParamSubUnionPkLoader) NewLoader(ctx context.Context) *TerminalParamSubUnionPkLoader {

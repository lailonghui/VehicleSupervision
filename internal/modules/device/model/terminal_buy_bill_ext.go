...
// 新建主键dataloader
func (t *TerminalBuyBillPkLoader) NewLoader(ctx context.Context) *TerminalBuyBillPkLoader {
	return &TerminalBuyBillPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*TerminalBuyBill, []error) {
			var rs []*TerminalBuyBill = make([]*TerminalBuyBill, len(keys))
...
// 新建联合主键dataloader
func (t *TerminalBuyBillUnionPkLoader) NewLoader(ctx context.Context) *TerminalBuyBillUnionPkLoader {

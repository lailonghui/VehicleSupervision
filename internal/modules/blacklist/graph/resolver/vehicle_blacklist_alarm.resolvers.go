...
func (r *mutationResolver) DeleteVehicleBlacklistAlarm(ctx context.Context, where model.VehicleBlacklistAlarmBoolExp) (*model.VehicleBlacklistAlarmMutationResponse, error) {
	...
	var m = &model1.VehicleBlacklistAlarm{}
	// 查询主键和联合主键
...
func (r *mutationResolver) DeleteVehicleBlacklistAlarmByPk(ctx context.Context, id int64) (*model1.VehicleBlacklistAlarm, error) {
	var rs model1.VehicleBlacklistAlarm
	m := &model1.VehicleBlacklistAlarm{}
	tx := db.DB.Model(m)
	// 查询记录
...
func (r *mutationResolver) DeleteVehicleBlacklistAlarmByUnionPk(ctx context.Context, alarmID string) (*model1.VehicleBlacklistAlarm, error) {
	var rs model1.VehicleBlacklistAlarm
	m := &model1.VehicleBlacklistAlarm{}
...
func (r *mutationResolver) InsertVehicleBlacklistAlarmOne(ctx context.Context, objects model.VehicleBlacklistAlarmInsertInput) (*model1.VehicleBlacklistAlarm, error) {
...
func (r *mutationResolver) UpdateVehicleBlacklistAlarmByUnionPk(ctx context.Context, inc *model.VehicleBlacklistAlarmIncInput, set *model.VehicleBlacklistAlarmSetInput, alarmID string) (*model1.VehicleBlacklistAlarm, error) {
	var rs model1.VehicleBlacklistAlarm
	var m = &model1.VehicleBlacklistAlarm{}
	// 更新数据库
...
func (r *queryResolver) VehicleBlacklistAlarmByUnionPk(ctx context.Context, alarmID string) (*model1.VehicleBlacklistAlarm, error) {
	var rs model1.VehicleBlacklistAlarm
	var m = &model1.VehicleBlacklistAlarm{}
	if middle.IsEnableGqlCache(ctx) {
		// 如果启用缓存，则从缓存中查询数据
		...
		if err != nil {
			if err == gorm.ErrRecordNotFound {
				if cacheErr == nil {
					_ = cacheAspect.SetNotExistUnionPkQueryCache(ctx, cacheKey, model1.VehicleBlacklistAlarm{})
				}
				return &rs, nil
			}
			return nil, err

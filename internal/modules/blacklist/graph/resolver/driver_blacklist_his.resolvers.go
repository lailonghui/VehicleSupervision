...
func (r *mutationResolver) DeleteDriverBlacklistHis(ctx context.Context, where model.DriverBlacklistHisBoolExp) (*model.DriverBlacklistHisMutationResponse, error) {
	...
	var m = &model1.DriverBlacklistHis{}
	// 查询主键和联合主键
...
func (r *mutationResolver) DeleteDriverBlacklistHisByUnionPk(ctx context.Context, hisID string) (*model1.DriverBlacklistHis, error) {
	var rs model1.DriverBlacklistHis
	m := &model1.DriverBlacklistHis{}
...
func (r *mutationResolver) InsertDriverBlacklistHisOne(ctx context.Context, objects model.DriverBlacklistHisInsertInput) (*model1.DriverBlacklistHis, error) {
...
func (r *mutationResolver) UpdateDriverBlacklistHisByUnionPk(ctx context.Context, inc *model.DriverBlacklistHisIncInput, set *model.DriverBlacklistHisSetInput, hisID string) (*model1.DriverBlacklistHis, error) {
	var rs model1.DriverBlacklistHis
	var m = &model1.DriverBlacklistHis{}
	// 更新数据库
...
func (r *queryResolver) DriverBlacklistHisByUnionPk(ctx context.Context, hisID string) (*model1.DriverBlacklistHis, error) {
	var rs model1.DriverBlacklistHis
	var m = &model1.DriverBlacklistHis{}
	if middle.IsEnableGqlCache(ctx) {
		// 如果启用缓存，则从缓存中查询数据
		...
		if err != nil {
			if err == gorm.ErrRecordNotFound {
				if cacheErr == nil {
					_ = cacheAspect.SetNotExistUnionPkQueryCache(ctx, cacheKey, model1.DriverBlacklistHis{})
				}
				return &rs, nil
			}
			return nil, err

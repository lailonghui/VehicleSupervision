...
func (r *mutationResolver) DeleteVehicleBlacklistHis(ctx context.Context, where model.VehicleBlacklistHisBoolExp) (*model.VehicleBlacklistHisMutationResponse, error) {
	...
	var m = &model1.VehicleBlacklistHis{}
	// 查询主键和联合主键
...
func (r *mutationResolver) DeleteVehicleBlacklistHisByUnionPk(ctx context.Context, hisID string) (*model1.VehicleBlacklistHis, error) {
	var rs model1.VehicleBlacklistHis
	m := &model1.VehicleBlacklistHis{}
...
func (r *mutationResolver) InsertVehicleBlacklistHisOne(ctx context.Context, objects model.VehicleBlacklistHisInsertInput) (*model1.VehicleBlacklistHis, error) {
...
func (r *mutationResolver) UpdateVehicleBlacklistHisByUnionPk(ctx context.Context, inc *model.VehicleBlacklistHisIncInput, set *model.VehicleBlacklistHisSetInput, hisID string) (*model1.VehicleBlacklistHis, error) {
	var rs model1.VehicleBlacklistHis
	var m = &model1.VehicleBlacklistHis{}
	// 更新数据库
...
func (r *queryResolver) VehicleBlacklistHisByUnionPk(ctx context.Context, hisID string) (*model1.VehicleBlacklistHis, error) {
	var rs model1.VehicleBlacklistHis
	var m = &model1.VehicleBlacklistHis{}
	if middle.IsEnableGqlCache(ctx) {
		// 如果启用缓存，则从缓存中查询数据
		...
		if err != nil {
			if err == gorm.ErrRecordNotFound {
				if cacheErr == nil {
					_ = cacheAspect.SetNotExistUnionPkQueryCache(ctx, cacheKey, model1.VehicleBlacklistHis{})
				}
				return &rs, nil
			}
			return nil, err

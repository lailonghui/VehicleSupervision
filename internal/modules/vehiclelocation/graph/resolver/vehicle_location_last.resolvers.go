...
func (r *mutationResolver) DeleteVehicleLocationLast(ctx context.Context, where model.VehicleLocationLastBoolExp) (*model.VehicleLocationLastMutationResponse, error) {
	...
	var m = &model1.VehicleLocationLast{}
	// 查询主键和联合主键
...
func (r *mutationResolver) InsertVehicleLocationLastOne(ctx context.Context, objects model.VehicleLocationLastInsertInput) (*model1.VehicleLocationLast, error) {

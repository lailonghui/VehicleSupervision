...
// 新建主键dataloader
func (t *VehicleLocationHisPkLoader) NewLoader(ctx context.Context) *VehicleLocationHisPkLoader {
	return &VehicleLocationHisPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*VehicleLocationHis, []error) {
			var rs []*VehicleLocationHis = make([]*VehicleLocationHis, len(keys))

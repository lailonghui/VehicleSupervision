...
func (r *mutationResolver) DeleteOperatingVehicleExt(ctx context.Context, where model.OperatingVehicleExtBoolExp) (*model.OperatingVehicleExtMutationResponse, error) {
	...
	var m = &model1.OperatingVehicleExt{}
	// 查询主键和联合主键
...
func (r *mutationResolver) InsertOperatingVehicleExtOne(ctx context.Context, objects model.OperatingVehicleExtInsertInput) (*model1.OperatingVehicleExt, error) {

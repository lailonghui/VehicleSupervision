...
type VehicleInfoBoolExp struct {
	...
	CreateAt                    *TimestampComparisonExp     `json:"create_at"`
	CreateBy                    *model.StringComparisonExp  `json:"create_by"`
	DeleteAt                    *TimestampComparisonExp     `json:"delete_at"`
	DeleteBy                    *TimestampComparisonExp     `json:"delete_by"`
	DepartmentID                *model.StringComparisonExp  `json:"department_id"`
	...
	InspectionDate              *TimestampComparisonExp     `json:"inspection_date"`
	InsuranceCompany            *model.IntComparisonExp     `json:"insurance_company"`
	InsuranceDate               *TimestampComparisonExp     `json:"insurance_date"`
	IsActive                    *model.BooleanComparisonExp `json:"is_active"`
	...
	RecordAt                    *TimestampComparisonExp     `json:"record_at"`
	RecordBy                    *model.StringComparisonExp  `json:"record_by"`
	RemarkIn                    *model.StringComparisonExp  `json:"remark_in"`
	Remarks                     *model.StringComparisonExp  `json:"remarks"`
	RetirementDate              *TimestampComparisonExp     `json:"retirement_date"`
	...
	UpdateAt                    *TimestampComparisonExp     `json:"update_at"`
	UpdateBy                    *model.StringComparisonExp  `json:"update_by"`
	UpdateTimeIn                *TimestampComparisonExp     `json:"update_time_in"`

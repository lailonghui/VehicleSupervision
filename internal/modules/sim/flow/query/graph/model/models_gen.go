...
import (
	"VehicleSupervision/internal/modules/sim/flow/model"
...
type MutationRoot struct {
	...
	DeleteSimCardFlow *SimCardFlowMutationResponse `json:"delete_sim_card_flow"`
	// delete single row from the table: "sim_card_flow"
	DeleteSimCardFlowByPk *model.SimCardFlow `json:"delete_sim_card_flow_by_pk"`
	// insert data into the table: "sim_card_flow"
	InsertSimCardFlow *SimCardFlowMutationResponse `json:"insert_sim_card_flow"`
	// insert a single row into the table: "sim_card_flow"
	InsertSimCardFlowOne *model.SimCardFlow `json:"insert_sim_card_flow_one"`
	// update data of the table: "sim_card_flow"
	UpdateSimCardFlow *SimCardFlowMutationResponse `json:"update_sim_card_flow"`
	// update single row of the table: "sim_card_flow"
	UpdateSimCardFlowByPk *model.SimCardFlow `json:"update_sim_card_flow_by_pk"`
}

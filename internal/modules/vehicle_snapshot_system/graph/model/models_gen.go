...
type OfflineRegistrationRecordBoolExp struct {
	...
	ID                          *model.BigintComparisonExp          `json:"id"`
	OfflineRegistrationRecordID *model.StringComparisonExp          `json:"offline_registration_record_id"`
...
type OfflineRegistrationRecordOrderBy struct {
	ID                          *model.OrderBy `json:"id"`
	OfflineRegistrationRecordID *model.OrderBy `json:"offline_registration_record_id"`
...
const (
	...
	// 外部编码，由golang程序生成的xid，暴露到外部使用 ( 联合主键                                                   )
	OfflineRegistrationRecordSelectColumnOfflineRegistrationRecordID OfflineRegistrationRecordSelectColumn = "offline_registration_record_id"
...
var AllOfflineRegistrationRecordSelectColumn = []OfflineRegistrationRecordSelectColumn{
	...
	OfflineRegistrationRecordSelectColumnOfflineRegistrationRecordID,

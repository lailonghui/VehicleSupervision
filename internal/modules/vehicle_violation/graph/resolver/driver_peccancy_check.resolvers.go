...
func (r *mutationResolver) DeleteDriverPeccancyCheck(ctx context.Context, where model.DriverPeccancyCheckBoolExp) (*model.DriverPeccancyCheckMutationResponse, error) {
	...
	var m = &model1.DriverPeccancyCheck{}
	// 查询主键和联合主键
...
func (r *mutationResolver) InsertDriverPeccancyCheckOne(ctx context.Context, objects model.DriverPeccancyCheckInsertInput) (*model1.DriverPeccancyCheck, error) {

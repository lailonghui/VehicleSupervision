...
func (r *mutationResolver) DeleteViolationRegistration(ctx context.Context, where model.ViolationRegistrationBoolExp) (*model.ViolationRegistrationMutationResponse, error) {
	var rs []*model1.ViolationRegistration
	var m = &model1.ViolationRegistration{}
	// 查询主键和联合主键
	...
	amount := len(rs)
	if amount == 0 {
		return &model.ViolationRegistrationMutationResponse{
			AffectedRows: 0,
			Returning:    nil,
		}, nil
	}
...
func (r *mutationResolver) DeleteViolationRegistrationByPk(ctx context.Context, id int64) (*model1.ViolationRegistration, error) {
	var rs model1.ViolationRegistration
	m := &model1.ViolationRegistration{}
	tx := db.DB.Model(m)
	// 查询记录
...
func (r *mutationResolver) DeleteViolationRegistrationByUnionPk(ctx context.Context, violationRegistrationID string) (*model1.ViolationRegistration, error) {
	var rs model1.ViolationRegistration
	m := &model1.ViolationRegistration{}
	tx := db.DB.Model(&model1.ViolationRegistration{})
	// 查询
	tx = tx.Where(rs.UnionPrimaryColumnName()+" = ?", violationRegistrationID).First(&rs)
	if err := tx.Error; err != nil {
		if errors.Is(err, gorm.ErrRecordNotFound) {
			return nil, nil
		}
...
func (r *mutationResolver) InsertViolationRegistrationOne(ctx context.Context, objects model.ViolationRegistrationInsertInput) (*model1.ViolationRegistration, error) {
...
func (r *mutationResolver) UpdateViolationRegistration(ctx context.Context, inc *model.ViolationRegistrationIncInput, set *model.ViolationRegistrationSetInput, where model.ViolationRegistrationBoolExp) (*model.ViolationRegistrationMutationResponse, error) {
	qt := util.NewQueryTranslator(db.DB, &model1.ViolationRegistration{})
	var m = &model1.ViolationRegistration{}
	// 更新数据库
...
func (r *mutationResolver) UpdateViolationRegistrationByPk(ctx context.Context, inc *model.ViolationRegistrationIncInput, set *model.ViolationRegistrationSetInput, id int64) (*model1.ViolationRegistration, error) {
	var rs model1.ViolationRegistration
	var m = &model1.ViolationRegistration{}
	// 更新数据库
...
func (r *mutationResolver) UpdateViolationRegistrationByUnionPk(ctx context.Context, inc *model.ViolationRegistrationIncInput, set *model.ViolationRegistrationSetInput, violationRegistrationID string) (*model1.ViolationRegistration, error) {
	var rs model1.ViolationRegistration
	var m = &model1.ViolationRegistration{}
	// 更新数据库
	tx := db.DB.Where(rs.UnionPrimaryColumnName()+" = ?", violationRegistrationID)
	qt := util.NewQueryTranslator(tx, &model1.ViolationRegistration{})
	tx = qt.Inc(inc).Set(set).DoUpdate()
	if err := tx.Error; err != nil {
		return nil, err
...
func (r *queryResolver) ViolationRegistration(ctx context.Context, distinctOn []model.ViolationRegistrationSelectColumn, limit *int, offset *int, orderBy []*model.ViolationRegistrationOrderBy, where *model.ViolationRegistrationBoolExp) ([]*model1.ViolationRegistration, error) {
	var rs []*model1.ViolationRegistration
	var m = &model1.ViolationRegistration{}
...
func (r *queryResolver) ViolationRegistrationAggregate(ctx context.Context, distinctOn []model.ViolationRegistrationSelectColumn, limit *int, offset *int, orderBy []*model.ViolationRegistrationOrderBy, where *model.ViolationRegistrationBoolExp) (*model.ViolationRegistrationAggregate, error) {
	var rs model.ViolationRegistrationAggregate
	var m = &model1.ViolationRegistration{}
	// 获取聚合查询项
...
func (r *queryResolver) ViolationRegistrationByUnionPk(ctx context.Context, violationRegistrationID string) (*model1.ViolationRegistration, error) {
	var rs model1.ViolationRegistration
	var m = &model1.ViolationRegistration{}
	if middle.IsEnableGqlCache(ctx) {
		// 如果启用缓存，则从缓存中查询数据
		cacheAspect, cacheErr := cache.GetGqlCacheAspect(rs.TableName())
		cacheKey := violationRegistrationID
		if cacheErr == nil {
		...
		// 缓存中找不到数据的话，查询数据库获取数据
		tx := db.DB.Model(m).Where(rs.UnionPrimaryColumnName()+" = ?", violationRegistrationID).First(&rs)
		err := tx.Error
		if err != nil {
			if err == gorm.ErrRecordNotFound {
				if cacheErr == nil {

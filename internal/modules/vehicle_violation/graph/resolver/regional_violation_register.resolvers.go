...
func (r *mutationResolver) DeleteRegionalViolationRegister(ctx context.Context, where model.RegionalViolationRegisterBoolExp) (*model.RegionalViolationRegisterMutationResponse, error) {
	...
	var m = &model1.RegionalViolationRegister{}
	// 查询主键和联合主键
...
func (r *mutationResolver) DeleteRegionalViolationRegisterByPk(ctx context.Context, id int64) (*model1.RegionalViolationRegister, error) {
	var rs model1.RegionalViolationRegister
	m := &model1.RegionalViolationRegister{}
	tx := db.DB.Model(m)
	// 查询记录
...
func (r *mutationResolver) DeleteRegionalViolationRegisterByUnionPk(ctx context.Context, regionalViolationRegisterID string) (*model1.RegionalViolationRegister, error) {
	var rs model1.RegionalViolationRegister
	m := &model1.RegionalViolationRegister{}
	tx := db.DB.Model(&model1.RegionalViolationRegister{})
	// 查询
	tx = tx.Where(rs.UnionPrimaryColumnName()+" = ?", regionalViolationRegisterID).First(&rs)
	if err := tx.Error; err != nil {
		if errors.Is(err, gorm.ErrRecordNotFound) {
			return nil, nil
		}
...
func (r *mutationResolver) InsertRegionalViolationRegisterOne(ctx context.Context, objects model.RegionalViolationRegisterInsertInput) (*model1.RegionalViolationRegister, error) {
...
func (r *mutationResolver) UpdateRegionalViolationRegister(ctx context.Context, inc *model.RegionalViolationRegisterIncInput, set *model.RegionalViolationRegisterSetInput, where model.RegionalViolationRegisterBoolExp) (*model.RegionalViolationRegisterMutationResponse, error) {
	qt := util.NewQueryTranslator(db.DB, &model1.RegionalViolationRegister{})
	var m = &model1.RegionalViolationRegister{}
	// 更新数据库
...
func (r *mutationResolver) UpdateRegionalViolationRegisterByPk(ctx context.Context, inc *model.RegionalViolationRegisterIncInput, set *model.RegionalViolationRegisterSetInput, id int64) (*model1.RegionalViolationRegister, error) {
	var rs model1.RegionalViolationRegister
	var m = &model1.RegionalViolationRegister{}
	// 更新数据库
...
func (r *mutationResolver) UpdateRegionalViolationRegisterByUnionPk(ctx context.Context, inc *model.RegionalViolationRegisterIncInput, set *model.RegionalViolationRegisterSetInput, regionalViolationRegisterID string) (*model1.RegionalViolationRegister, error) {
	var rs model1.RegionalViolationRegister
	var m = &model1.RegionalViolationRegister{}
	// 更新数据库
	tx := db.DB.Where(rs.UnionPrimaryColumnName()+" = ?", regionalViolationRegisterID)
	qt := util.NewQueryTranslator(tx, &model1.RegionalViolationRegister{})
	tx = qt.Inc(inc).Set(set).DoUpdate()
	if err := tx.Error; err != nil {
		return nil, err
...
func (r *queryResolver) RegionalViolationRegister(ctx context.Context, distinctOn []model.RegionalViolationRegisterSelectColumn, limit *int, offset *int, orderBy []*model.RegionalViolationRegisterOrderBy, where *model.RegionalViolationRegisterBoolExp) ([]*model1.RegionalViolationRegister, error) {
	var rs []*model1.RegionalViolationRegister
	var m = &model1.RegionalViolationRegister{}
...
func (r *queryResolver) RegionalViolationRegisterByUnionPk(ctx context.Context, regionalViolationRegisterID string) (*model1.RegionalViolationRegister, error) {
	var rs model1.RegionalViolationRegister
	var m = &model1.RegionalViolationRegister{}
	if middle.IsEnableGqlCache(ctx) {
		// 如果启用缓存，则从缓存中查询数据
		cacheAspect, cacheErr := cache.GetGqlCacheAspect(rs.TableName())
		cacheKey := regionalViolationRegisterID
		if cacheErr == nil {
		...
		// 缓存中找不到数据的话，查询数据库获取数据
		tx := db.DB.Model(m).Where(rs.UnionPrimaryColumnName()+" = ?", regionalViolationRegisterID).First(&rs)
		err := tx.Error
		if err != nil {
			if err == gorm.ErrRecordNotFound {
				if cacheErr == nil {

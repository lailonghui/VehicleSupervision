...
func (r *mutationResolver) InsertRegionalViolationRegisterOne(ctx context.Context, object model.RegionalViolationRegisterInsertInput) (*model1.RegionalViolationRegister, error) {

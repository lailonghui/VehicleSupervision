...
// 新建主键dataloader
func (t *ControlLineTimePkLoader) NewLoader(ctx context.Context) *ControlLineTimePkLoader {
	return &ControlLineTimePkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*ControlLineTime, []error) {
			var rs []*ControlLineTime = make([]*ControlLineTime, len(keys))
...
// 新建联合主键dataloader
func (t *ControlLineTimeUnionPkLoader) NewLoader(ctx context.Context) *ControlLineTimeUnionPkLoader {

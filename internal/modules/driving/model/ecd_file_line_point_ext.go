...
// 新建主键dataloader
func (t *EcdFileLinePointPkLoader) NewLoader(ctx context.Context) *EcdFileLinePointPkLoader {
	return &EcdFileLinePointPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*EcdFileLinePoint, []error) {
			var rs []*EcdFileLinePoint = make([]*EcdFileLinePoint, len(keys))
...
// 新建联合主键dataloader
func (t *EcdFileLinePointUnionPkLoader) NewLoader(ctx context.Context) *EcdFileLinePointUnionPkLoader {

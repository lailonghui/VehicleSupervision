...
// 新建主键dataloader
func (t *EcdFileMainPkLoader) NewLoader(ctx context.Context) *EcdFileMainPkLoader {
	return &EcdFileMainPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*EcdFileMain, []error) {
			var rs []*EcdFileMain = make([]*EcdFileMain, len(keys))
			var m EcdFileMain
			wg := sync.WaitGroup{}
...
// 新建联合主键dataloader
func (t *EcdFileMainUnionPkLoader) NewLoader(ctx context.Context) *EcdFileMainUnionPkLoader {

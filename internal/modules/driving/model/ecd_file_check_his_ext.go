...
// 新建主键dataloader
func (t *EcdFileCheckHisPkLoader) NewLoader(ctx context.Context) *EcdFileCheckHisPkLoader {
	return &EcdFileCheckHisPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*EcdFileCheckHis, []error) {
			var rs []*EcdFileCheckHis = make([]*EcdFileCheckHis, len(keys))
...
// 新建联合主键dataloader
func (t *EcdFileCheckHisUnionPkLoader) NewLoader(ctx context.Context) *EcdFileCheckHisUnionPkLoader {

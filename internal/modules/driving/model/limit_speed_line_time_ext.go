...
// 新建主键dataloader
func (t *LimitSpeedLineTimePkLoader) NewLoader(ctx context.Context) *LimitSpeedLineTimePkLoader {
	return &LimitSpeedLineTimePkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*LimitSpeedLineTime, []error) {
			var rs []*LimitSpeedLineTime = make([]*LimitSpeedLineTime, len(keys))
...
// 新建联合主键dataloader
func (t *LimitSpeedLineTimeUnionPkLoader) NewLoader(ctx context.Context) *LimitSpeedLineTimeUnionPkLoader {

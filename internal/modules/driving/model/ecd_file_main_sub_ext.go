...
// 新建主键dataloader
func (t *EcdFileMainSubPkLoader) NewLoader(ctx context.Context) *EcdFileMainSubPkLoader {
	return &EcdFileMainSubPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*EcdFileMainSub, []error) {
			var rs []*EcdFileMainSub = make([]*EcdFileMainSub, len(keys))
...
// 新建联合主键dataloader
func (t *EcdFileMainSubUnionPkLoader) NewLoader(ctx context.Context) *EcdFileMainSubUnionPkLoader {

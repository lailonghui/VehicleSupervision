...
type MutationRoot struct {
	...
	DeleteDrivingLog *DrivingLogMutationResponse `json:"delete_driving_log"`
	// delete single row from the table: "driving_log"
	DeleteDrivingLogByPk *model.DrivingLog `json:"delete_driving_log_by_pk"`
	// insert data into the table: "driving_log"
	InsertDrivingLog *DrivingLogMutationResponse `json:"insert_driving_log"`
	// insert a single row into the table: "driving_log"
	InsertDrivingLogOne *model.DrivingLog `json:"insert_driving_log_one"`
	// update data of the table: "driving_log"
	UpdateDrivingLog *DrivingLogMutationResponse `json:"update_driving_log"`
	// update single row of the table: "driving_log"
	UpdateDrivingLogByPk *model.DrivingLog `json:"update_driving_log_by_pk"`
}

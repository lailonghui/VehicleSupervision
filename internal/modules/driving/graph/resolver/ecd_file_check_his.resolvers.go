...
func (r *mutationResolver) DeleteEcdFileCheckHisByUnionPk(ctx context.Context, hisID string) (*model1.EcdFileCheckHis, error) {
	var rs model1.EcdFileCheckHis
	m := &model1.EcdFileCheckHis{}
...
func (r *mutationResolver) InsertEcdFileCheckHisOne(ctx context.Context, objects model.EcdFileCheckHisInsertInput) (*model1.EcdFileCheckHis, error) {
...
func (r *mutationResolver) UpdateEcdFileCheckHisByUnionPk(ctx context.Context, inc *model.EcdFileCheckHisIncInput, set *model.EcdFileCheckHisSetInput, hisID string) (*model1.EcdFileCheckHis, error) {
	var rs model1.EcdFileCheckHis
	var m = &model1.EcdFileCheckHis{}
	// 更新数据库
...
func (r *queryResolver) EcdFileCheckHisByUnionPk(ctx context.Context, hisID string) (*model1.EcdFileCheckHis, error) {
	var rs model1.EcdFileCheckHis
	var m = &model1.EcdFileCheckHis{}
	if middle.IsEnableGqlCache(ctx) {
		// 如果启用缓存，则从缓存中查询数据
		...
		if err != nil {
			if err == gorm.ErrRecordNotFound {
				if cacheErr == nil {
					_ = cacheAspect.SetNotExistUnionPkQueryCache(ctx, cacheKey, model1.EcdFileCheckHis{})
				}
				return &rs, nil
			}
			return nil, err

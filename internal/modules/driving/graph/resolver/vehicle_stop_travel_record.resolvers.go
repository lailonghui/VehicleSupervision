...
func (r *mutationResolver) DeleteVehicleStopTravelRecord(ctx context.Context, where model.VehicleStopTravelRecordBoolExp) (*model.VehicleStopTravelRecordMutationResponse, error) {
	...
	var m = &model1.VehicleStopTravelRecord{}
	// 查询主键和联合主键
...
func (r *mutationResolver) DeleteVehicleStopTravelRecordByPk(ctx context.Context, id int64) (*model1.VehicleStopTravelRecord, error) {
	var rs model1.VehicleStopTravelRecord
	m := &model1.VehicleStopTravelRecord{}
	tx := db.DB.Model(m)
	// 查询记录
...
func (r *mutationResolver) DeleteVehicleStopTravelRecordByUnionPk(ctx context.Context, recordID string) (*model1.VehicleStopTravelRecord, error) {
	var rs model1.VehicleStopTravelRecord
	m := &model1.VehicleStopTravelRecord{}
...
func (r *mutationResolver) InsertVehicleStopTravelRecordOne(ctx context.Context, objects model.VehicleStopTravelRecordInsertInput) (*model1.VehicleStopTravelRecord, error) {
...
func (r *mutationResolver) UpdateVehicleStopTravelRecordByUnionPk(ctx context.Context, inc *model.VehicleStopTravelRecordIncInput, set *model.VehicleStopTravelRecordSetInput, recordID string) (*model1.VehicleStopTravelRecord, error) {
	var rs model1.VehicleStopTravelRecord
	var m = &model1.VehicleStopTravelRecord{}
	// 更新数据库
...
func (r *queryResolver) VehicleStopTravelRecordByUnionPk(ctx context.Context, recordID string) (*model1.VehicleStopTravelRecord, error) {
	var rs model1.VehicleStopTravelRecord
	var m = &model1.VehicleStopTravelRecord{}
	if middle.IsEnableGqlCache(ctx) {
		// 如果启用缓存，则从缓存中查询数据
		...
		if err != nil {
			if err == gorm.ErrRecordNotFound {
				if cacheErr == nil {
					_ = cacheAspect.SetNotExistUnionPkQueryCache(ctx, cacheKey, model1.VehicleStopTravelRecord{})
				}
				return &rs, nil
			}
			return nil, err

...
func (r *mutationResolver) DeleteVehicleNightTravelRecord(ctx context.Context, where model.VehicleNightTravelRecordBoolExp) (*model.VehicleNightTravelRecordMutationResponse, error) {
	...
	var m = &model1.VehicleNightTravelRecord{}
	// 查询主键和联合主键
...
func (r *mutationResolver) DeleteVehicleNightTravelRecordByPk(ctx context.Context, id int64) (*model1.VehicleNightTravelRecord, error) {
	var rs model1.VehicleNightTravelRecord
	m := &model1.VehicleNightTravelRecord{}
	tx := db.DB.Model(m)
	// 查询记录
...
func (r *mutationResolver) DeleteVehicleNightTravelRecordByUnionPk(ctx context.Context, recordID string) (*model1.VehicleNightTravelRecord, error) {
	var rs model1.VehicleNightTravelRecord
	m := &model1.VehicleNightTravelRecord{}
...
func (r *mutationResolver) InsertVehicleNightTravelRecordOne(ctx context.Context, objects model.VehicleNightTravelRecordInsertInput) (*model1.VehicleNightTravelRecord, error) {
...
func (r *mutationResolver) UpdateVehicleNightTravelRecordByUnionPk(ctx context.Context, inc *model.VehicleNightTravelRecordIncInput, set *model.VehicleNightTravelRecordSetInput, recordID string) (*model1.VehicleNightTravelRecord, error) {
	var rs model1.VehicleNightTravelRecord
	var m = &model1.VehicleNightTravelRecord{}
	// 更新数据库
...
func (r *queryResolver) VehicleNightTravelRecordByUnionPk(ctx context.Context, recordID string) (*model1.VehicleNightTravelRecord, error) {
	var rs model1.VehicleNightTravelRecord
	var m = &model1.VehicleNightTravelRecord{}
	if middle.IsEnableGqlCache(ctx) {
		// 如果启用缓存，则从缓存中查询数据

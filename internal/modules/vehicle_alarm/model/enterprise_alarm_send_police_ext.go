...
//go:generate go run github.com/vektah/dataloaden EnterpriseAlarmSendPoliceUnionPkLoader string *VehicleSupervision/internal/modules/vehicle_alarm/model.EnterpriseAlarmSendPolice

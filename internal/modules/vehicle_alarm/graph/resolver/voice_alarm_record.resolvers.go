...
func (r *mutationResolver) InsertVoiceAlarmRecordOne(ctx context.Context, objects model.VoiceAlarmRecordInsertInput) (*model1.VoiceAlarmRecord, error) {

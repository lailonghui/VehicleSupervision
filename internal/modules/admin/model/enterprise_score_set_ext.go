...
// 新建主键dataloader
func (t *EnterpriseScoreSetPkLoader) NewLoader(ctx context.Context) *EnterpriseScoreSetPkLoader {
	return &EnterpriseScoreSetPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*EnterpriseScoreSet, []error) {
			var rs []*EnterpriseScoreSet = make([]*EnterpriseScoreSet, len(keys))
...
// 新建联合主键dataloader
func (t *EnterpriseScoreSetUnionPkLoader) NewLoader(ctx context.Context) *EnterpriseScoreSetUnionPkLoader {

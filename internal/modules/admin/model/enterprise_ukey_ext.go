...
// 新建主键dataloader
func (t *EnterpriseUkeyPkLoader) NewLoader(ctx context.Context) *EnterpriseUkeyPkLoader {
	return &EnterpriseUkeyPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*EnterpriseUkey, []error) {
			var rs []*EnterpriseUkey = make([]*EnterpriseUkey, len(keys))
...
// 新建联合主键dataloader
func (t *EnterpriseUkeyUnionPkLoader) NewLoader(ctx context.Context) *EnterpriseUkeyUnionPkLoader {

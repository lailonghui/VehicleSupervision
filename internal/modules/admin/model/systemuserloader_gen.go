...
// NewSystemUserLoader creates a new SystemUserLoader given a fetch, wait, and maxBatch
func NewSystemUserLoader(config SystemUserLoaderConfig) *SystemUserLoader {
...
func (l *SystemUserLoader) LoadThunk(key int64) func() (*SystemUser, error) {
	...
	if l.batch == nil {
		l.batch = &systemUserLoaderBatch{done: make(chan struct{})}
	}
	batch := l.batch
...
func (b *systemUserLoaderBatch) startTimer(l *SystemUserLoader) {
	time.Sleep(l.wait)
	l.mu.Lock()
...
func (b *systemUserLoaderBatch) end(l *SystemUserLoader) {

...
func (r *mutationResolver) InsertEnterprisePoliceSmsInfoOne(ctx context.Context, object model.EnterprisePoliceSmsInfoInsertInput) (*model1.EnterprisePoliceSmsInfo, error) {

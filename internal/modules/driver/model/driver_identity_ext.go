...
//go:generate go run github.com/vektah/dataloaden DriverIdentityUnionPkLoader string *VehicleSupervision/internal/modules/driver/model.DriverIdentity
...
// 主键列名
func (t *DriverIdentity) PrimaryColumnName() string {
	return "id"
}

// 获取主键
func (t *DriverIdentity) GetPrimary() int64 {
	return t.ID
}

// 新建主键dataloader
func (t *DriverIdentityPkLoader) NewLoader(ctx context.Context) *DriverIdentityPkLoader {
	return &DriverIdentityPkLoader{
		wait:     2 * time.Millisecond,
		maxBatch: 100,
		fetch: func(keys []string) ([]*DriverIdentity, []error) {
			var rs []*DriverIdentity = make([]*DriverIdentity, len(keys))
			var m DriverIdentity
			wg := sync.WaitGroup{}
...
// 联合主键列名
func (t *DriverIdentity) UnionPrimaryColumnName() string {
	return "identity_id"
}

// 获取联合主键
func (t *DriverIdentity) GetUnionPrimary() string {
	return t.IdentityID
}

// 新建联合主键dataloader
func (t *DriverIdentityUnionPkLoader) NewLoader(ctx context.Context) *DriverIdentityUnionPkLoader {
